...
async function pctest(
  ...
  hre: HardhatRuntimeEnvironment
    ...
    try {
      const MentalPokerTest = await hre.ethers.getContractFactory("MentalPokerTest");
      const mentalPokerTest = await MentalPokerTest.deploy(args.contr, { gasPrice: hre.ethers.provider.getGasPrice() });
